...
<body>
     ...
     <header>
    <nav>
        <a href="./indexB1.html">Home</a>
    </nav>
     </header>
  
    <form>
      <div class="style_mobileLogoWrapper__llQfg">
        <svg
          width="80"
          height="80"
          fill="none"
      ...
      <h2 class="form_heading">Application Form</h2>
    ...
    <div class="field">
        <label id="selectDate">Date of Birth<span style="color: red;">*</span></label><br>
      ...
      <div class="field-container">
    <div class="field">
      <label for="emailAddress">Email Address<span style="color: red;">*</span></label><br>
      <input type="email" id="emailAddress" name="emailAddress"  placeholder="Enter email address">
     </div>
      
      <div class="field">
      <label for="educationLevel">Education Level<span style="color: red;">*</span></label><br>
      <select id="educationLevel" name="educationLevel" required>
        ...
        <option value="highschool/secondaryschool">High School / Secondary School</option> 
        <option value="undergraduate">Undergraduate</option> 
        <option value="junior/middleschool">Junior / Middle School</option> 
      ...
      <select id="country" textbox="type text" name="country" required>
        <option value="" selected >Select your country</option>
          ...
          <option value="Eswatini (formerly Swaziland)">Eswatini</option>
          ...
          <option value="Myanmar (formerly Burma)">Myanmar </option>
          ...
          <option value="North Macedonia (formerly Macedonia)">North Macedonia </option>
     ...
     <div class="field">
      <label for="states/city">State/City of Residence<span style="color: red;">*</span></label><br>
      <input type="text" id="states/city" name="states/city"  placeholder="Enter your state of Residence" /> 
     </div>
     </div>

      <div class="field-container">
        <div class="field">
      <label for="status">Employment Status<span style="color: red;">*</span></label><br>
      ...
      <input type="text" id="phoneNumber" name="phoneNumber" placeholder="08154387000" required/>
     </div>
    </div>

     <div class="field-container">
        <div class="field">
      <label for="school">Choose School<span style="color: red;">*</span></label><br>
    ...
    <div class="field">
      <label for="course">Choose Course of Study<span style="color: red;">*</span></label><br>
      ...
      ><br />
           ...
           <div class="field-container">
        <div class="field">
      <label for="channel">How did you hear about us? <span style="color: red;">*</span></label><br/>
    ...
    <div class="field">
      <label for="discount/scholarship"><p>Scholarship/Discount Code (optional)</p></label><br>
      <input type="text" id="discount/scholarship" name="discount/scholarship" placeholder="Scholarship or student ID or discount code" />
    </div>
    </div>


      <p>By clicking continue, I agree to <strong style="color: rgb(106, 111, 245);">Terms of Use</strong> and acknowledge <br>that I<br> have read the <strong style="color: rgb(106, 111, 245);">Privacy Policy</strong></p>
    ...
    <p class="small-text">Already have an account? <a href="#" style="color: rgb(106, 111, 245);">Sign In</a></p>
  </body>
</html>
